...
public class AllDiscountCalculateTest {
    ...
    void 총_할인율_테스트(VisitDate visitDate, int totalPrice, int expectedDiscount) {
    ...
    private static Stream<Arguments> provideDatesAndExpectedDiscounts() {
        return Stream.of(
                Arguments.of(new VisitDate("1"), 186000, 7069), // christmasEvent 1000, dayOfWeekEvent 6069
                Arguments.of(new VisitDate("3"), 186000, 6246),
                // christmasEvent 1200, dayOfWeekEvent 4046, dateOfStarsEvent 1000
                Arguments.of(new VisitDate("12"), 186000, 6146), // christmasEvent 2100, dayOfWeekEvent 4046
                Arguments.of(new VisitDate("16"), 186000, 8569), // christmasEvent 2500, dayOfWeekEvent 6069
                Arguments.of(new VisitDate("25"), 186000, 8446),
                // christmasEvent 3400, dayOfWeekEvent 4046, dateOfStartsEvent 1000
                Arguments.of(new VisitDate("26"), 186000, 4046), // dayOfWeekEvent 4046
                Arguments.of(new VisitDate("29"), 186000, 6069), // dayOfWeekEvent 6069
                Arguments.of(new VisitDate("31"), 186000, 5046) // dayOfWeekEvent 4046, dateOfStartsEvent 1000
        );
    }
    ...
    void 할인_못_받는_경우_테스트(VisitDate visitDate, int totalPrice, int expectedDiscount) {
    ...
    private static Stream<Arguments> provideUnderMinimumDiscount() {
        return Stream.of(
                Arguments.of(new VisitDate("1"), 9000, 0),
                Arguments.of(new VisitDate("3"), 9000, 0),
                Arguments.of(new VisitDate("13"), 9000, 0),
                Arguments.of(new VisitDate("25"), 9000, 0),
                Arguments.of(new VisitDate("30"), 9000, 0)
        );
